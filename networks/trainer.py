...
class ChembleTrainer:

    def __init__(self, model, train_dataset, test_dataset, config,current_gpu=0):
        self.model = model
        ...
        if torch.cuda.is_available():
            self.device = torch.device("cuda:"+str(current_gpu))
    ...
    def train(self,self_train = False):
