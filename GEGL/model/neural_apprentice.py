...
class SmilesGenerator(nn.Module):
    ...
    def save(self, save_dir,target_cell=''):
        model_config = self.config
        model_config_path = os.path.join(save_dir, target_cell+"_generator_config.json")
        with open(model_config_path, "w") as f:
            json.dump(model_config, f)

        model_state_dict = self.state_dict()
        model_weight_path = os.path.join(save_dir, target_cell+"_generator_weight.pt")
