"""
This code is from https://github.com/kimmo1019/DeepCDR, DeepCDR (a hybrid graph convolutional network for predicting cancer drug response).

Information about thier copyright is in https://github.com/kimmo1019/DeepCDR/blob/master/LICENSE.
